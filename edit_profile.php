			...
			<div class="col-md-6">
    			<div class="well well-lg" style="background-color:#222;">
					<?php
						...
						$edit_id = $_SESSION['username1'];

						$sql = "SELECT * FROM administrator WHERE username='$edit_id'";
					...
					<form role="form" method="post">
  						<div class="form-group">
						    ...
						    <input type="text" class="form-control" name="nnn" value="<?php echo $row['password'] ; ?>" >
  						</div>
  						<div class="form-group">
...
if (isset($_POST['sub7']) ){
	...
	$sql = "UPDATE administrator set password='$password' where username='$edit_id'";
