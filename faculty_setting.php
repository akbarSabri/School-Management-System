			...
			<div class="col-md-6">
    			<div class="well well-lg" style="background-color:#222;">
					<?php
						...
						$edit_id = $_SESSION['username2'];

						$sql = "SELECT * FROM faculty WHERE faculty_id='$edit_id'";
					...
					<form role="form" method="post">
  						<div class="form-group">
						    ...
						    <input type="text" class="form-control" name="nnn" value="<?php echo $row['faculty_password'] ; ?>" >
  						</div>
  						<div class="form-group">
...
if (isset($_POST['sub7']) ){
	...
	$sql = "UPDATE faculty set faculty_password='$password' where faculty_id='$edit_id'";
